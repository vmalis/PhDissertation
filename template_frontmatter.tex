...
%
\begin{abstract}
The disproportionate loss of human muscle force with aging and disuse atrophy compared to the loss of muscle mass is not yet completely understood. 
Neural and contractile components, investigated extensively, are considered to be the main determinants of such age-related loss of force.  
Remodeling of the extracellular matrix (ECM) has been recently  shown, in animal models, to be another important contributor.  
\textit{In-vivo} human studies exploring the structural remodeling of the ECM and its functional consequences have been lacking due to the paucity of appropriate  imaging techniques.  
This study focuses on the development and application of advanced methods of Magnetic Resonance Imaging (MRI) to elucidate the mechanisms of loss of force with aging and disuse atrophy with the focus on ECM. 
%-new paragraph-%

%-new paragraph-%
Functional changes are investigated by strain and strain rate tensor mapping of the muscle tissue under dynamic force contraction cycles using Velocity Encoded Phase-Contrast MRI. 
This technique is limited by long scan times. 
Development and implementation of compressed sensing MR acquisition and reconstruction framework reduce scan times to under a minute, thus allowing acquisition in senior subjects. 
3D strain / strain rate tensor extracted from these images were shown to correlate with force loss due to aging and disuse atrophy, reflecting the material properties of the ECM. 
Thus, the developed techniques elucidates the role of the ECM and potentially that of lateral transmission of force in loss of muscle force.
%-new paragraph-%
...
%-new paragraph-%
The rapid imaging and modeling techniques developed herein, integrated with data from other MR studies, have yielded unique data which can potentially provide the causal link between age- and disuse-related structural remodeling and its functional consequences. 
\end{abstract}
