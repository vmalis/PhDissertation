...
%
\begin{abstract}
The loss of human muscle force with aging and disuse atrophy is disproportionately greater than the loss of muscle mass and is not yet completely understood.  
Among potential determinants of age-related loss of muscle force that has not been investigated in depth is the remodeling of the extracellular matrix and its functional consequences. 
This study focuses on application of advanced methods of Magnetic Resonance Imaging (MRI) to study these changes.
%-new paragraph-%

%-new paragraph-%
Functional changes are investigated by strain and strain rate tensor mapping of the muscle tissue under dynamic conditions using Velocity Encoded Phase-Contrast (VEPC) technique. 
Application of VEPC MRI for age related studies is limited due to long scan times.
Implementation of compressed sensing acquisition and reconstruction framework allowed for successful acquisition of velocity encoded data in senior humans and at submaximal levels of force. 
Changes in strain and strain rate tensor as well as their  ability to predict force and force changes reflect the role of remodeling of the extracellular matrix  and its functional consequence in reducing lateral transmission of force.
%-new paragraph-%

%-new paragraph-%
Diffusion tensor imaging (DTI) assesses underlying tissue microstructure, and has been applied to studying skeletal muscle. 
Disuse atrophy and aging cause decreases in muscle force, mass, and muscle protein synthesis as well as changes in muscle architecture.
Low resolution of diffusion tensor imaging prevents the direct measurements of tissue micro architecture. 
To address this limitation bicompartmental and Random Permeable Barrier (RPBM) models of the diffusion were applied to diffusion data obtained with spin-echo and stimulated echo echo planar imaging sequences respectively. 
Changes in diffusion tensor eigenvalues were observed and model derived parameters were in physiologically reasonable range.
%-new paragraph-%

%-new paragraph-%
These MR imaging bio-markers are anticipated to translate to the clinical use to non-invasively monitor musculoskeletal disease conditions.
\end{abstract}
